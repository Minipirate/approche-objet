...
public class ManipulationChaine {
	...
	public static void main(String[] args) {
		...
		// Méthode indexOf(char c) pour afficher l'index du 1er ";" contenu dans la
		// chaîne
		System.out.println("\nL'index du premier point virgule contenu dans la chaîne de caractères est l'index "
				+ chaine.indexOf(";"));

		// Combinaison de la Méthode substring(int start, int end) et indexOf afin
		// d'extraire le nom de famille de la personne
